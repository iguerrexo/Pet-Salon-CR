...
//create 2 objects
const Scooby = new Pet("Scooby",60,"Dane","Male","Full Service","Shaggy","568-978-3389");
salon.pets.push(Scooby);
displayTable(Scooby);

const Karmady = new Pet("Butters",5,"Labador","Female","Full Service","Nora","805-293-3393");
salon.pets.push(Karmady);
displayTable(Karmady);
